...
const ongoingProjects = [
  {
    ...
    description:
      "Create a professional portfolio website showcasing projects and skills using React and Tailwind CSS.",
  ...
  },
  {
    ...
    description:
      "Build an image classification model using TensorFlow to identify objects in photographs.",
  ...
  },
  {
    ...
    description:
      "Develop a cross-platform mobile application using React Native for task management.",
  ...
  return (
    <ProfessorLayout>
      <div className="container mx-auto p-4 md:p-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold">Welcome back, Dr. Taylor!</h1>
        ...
        <div className="grid gap-6 md:grid-cols-1 lg:grid-cols-3">
          <Card className="lg:col-span-2">
            <CardHeader>
              ...
              <CardDescription>
                Projects you are currently mentoring
              </CardDescription>
            </CardHeader>
            <CardContent>
