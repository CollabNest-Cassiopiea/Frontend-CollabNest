...
import MyProject from "../components/student/myproject"; // Import the MyProject component
...
const recommendedProjects: Project[] = [
  {
    ...
    description:
      "Create musical visuals for your songs with your Spotify playlist",
    image: undefined,
  },
  {
    title: "AI Dungeon",
...
const StudentDashboard: React.FC = () => {
  ...
  const [scheduledMeets] = useState<{ time: string; date: string }[]>([]);
  const [selectedProject, setSelectedProject] = useState<Project | null>(null);
  const [notifications] = useState(3); // Number of notifications
  const [showNotifications, setShowNotifications] = useState(false);
  const [activeView, setActiveView] = useState("home"); // Track which view is active: "home" or "myProjects"
  ...
  return (
    ...
    >
      {/* Mobile Sidebar */}
      <div
        className={`lg:hidden fixed inset-y-0 left-0 z-50 w-64 bg-black p-4 transform transition-transform duration-300 ${
      ...
      >
        ...
        <nav className="flex flex-col gap-4">
          <button
            ...
            className={`text-left ${
              activeView === "home" ? "text-white bg-gray-800" : "text-gray-300"
          ...
          <button
            ...
            className={`text-left ${
              activeView === "myProjects"
                ...
                : "text-gray-300"
            } py-3 px-4 hover:bg-gray-800 rounded-lg transition`}
          >
            My Projects
          </button>
          <button
      ...
      <div className="flex-1 p-6 relative">
          ...
          <div className="relative">
            ...
            {showNotifications && (
              <div className="absolute right-0 mt-2 w-64 bg-gray-800 border border-gray-700 rounded-md shadow-lg p-2 z-50">
                <h3 className="text-stone-200 font-medium p-2 border-b border-gray-700">
                  Notifications
                </h3>
                <div className="py-2">
                  <div className="p-2 hover:bg-gray-700 rounded-md cursor-pointer">
                    <p className="text-stone-200 text-sm">
                      Your project "CollabNest" has been reviewed
                    </p>
                    <p className="text-gray-400 text-xs mt-1">2 hours ago</p>
                  </div>
                  <div className="p-2 hover:bg-gray-700 rounded-md cursor-pointer">
                    <p className="text-stone-200 text-sm">
                      New meeting scheduled for tomorrow
                    </p>
                    <p className="text-gray-400 text-xs mt-1">Yesterday</p>
                  </div>
                  <div className="p-2 hover:bg-gray-700 rounded-md cursor-pointer">
                    <p className="text-stone-200 text-sm">
                      Certificate available for "React Basics"
                    </p>
                ...
                <div className="border-t border-gray-700 p-2">
                  <a
                    href="#"
                    className="text-sm text-stone-200 hover:text-stone-400 flex justify-center"
                  >
        ...
        {/* Content Container - Conditionally render based on activeView */}
        {activeView === "home" ? (
          <>
            {/* Home View Content */}
            {/* Welcome Section */}
            ...
            {/* Project Section */}
            <div
              className="border-[0.1px] border-gray-400/30 p-4 rounded-xl mb-6 flex items-center justify-between"
              style={{ backgroundColor: darkBg }}
            >
              <div>
                ...
                <p className="text-sm text-gray-400 max-w-2xl mb-4">
                  ...
                  students with mentors &amp; professionals for hands-on
                  experience.
                </p>
              </div>
              <button
          ...
          // My Projects View - Import and render the MyProject component
          <MyProject />
        ) : null}
      </div>
